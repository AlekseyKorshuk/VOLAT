...
Tank::Tank(int x, int y, int z, int health_points, int capture_points) : Content(is_reacheble=false, content_type=ContentType::VEHICLE), x_(x), y_(y), z_(z), health_points(health_points), capture_points(capture_points){
